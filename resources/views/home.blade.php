    ...
    <section id="intro" class="wrapper style1 fullscreen fade-up">
        <div class="inner">
            ...
            <form id="formImage">
                ...
                <img id="blah" src="#" alt="Виберіть зображення"/>
            </form>

            <ul class="actions">
                <li><a href="#one" class="button scrolly">Далі</a></li>
            </ul>
        </div>
    </section>

    <!-- One -->
    <section id="one9" class="wrapper style2 spotlights">
        <section>
